			...
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				...
				<tbody class="corps">
					...
					<td><?php if($l->sm2_sLibelle !=NULL){echo $l->sm2_sLibelle ;}elseif($l->sm1_sLibelle !=NULL){echo $l->sm1_sLibelle ;}elseif($l->mal_sLibelle !=NULL){echo $l->mal_sLibelle ;} ?></td>
						...
						<td style="font-size:11.5px;" align="center"><?php $nc = $this->md_patient->rapport_maladie_nouveau($l->sm1_id,$l->sm2_id,$l->mal_id,"2019-09-05","2019-09-12");echo $nc->nb;$som_1=$som_1+$nc->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ac = $this->md_patient->rapport_maladie_ancien($l->sm1_id,$l->sm2_id,$l->mal_id,"2019-09-05");echo $ac->nb;$som_2=$som_2+$ac->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php echo $nc->nb + $ac->nb; ?></td>
						<td style="font-size:11.5px;" align="center"><?php $chmoisun = $this->md_patient->rapport_maladie_moin_1($l->sm1_id,$l->sm2_id,$l->mal_id,$moinsun,"H");echo $chmoisun->nb;$som_4=$som_4+$chmoisun->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cfmoisun = $this->md_patient->rapport_maladie_moin_1($l->sm1_id,$l->sm2_id,$l->mal_id, $moinsun,"F"); echo $cfmoisun->nb;$som_5=$som_5+$cfmoisun->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch14 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun,"H"); echo $ch14->nb;$som_6=$som_6+$ch14->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf14 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun,"F"); echo $cf14->nb;$som_7=$som_7+$cf14->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch514 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14,"H"); echo $ch514->nb;$som_8=$som_8+$ch514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf514 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14,"F"); echo $cf514->nb;$som_9=$som_9+$cf514->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch1549 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514,"H"); echo $ch1549->nb;$som_10=$som_10+$ch1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf1549 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514,"F"); echo $cf1549->nb; $som_11=$som_11+$cf1549->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $ch50plus = $this->md_patient->rapport_maladie_50_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus,"H"); echo $ch50plus->nb;$som_12=$som_12+$ch50plus->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $cf50plus = $this->md_patient->rapport_maladie_50_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus,"F"); echo $cf50plus->nb;$som_13=$som_13+$cf50plus->nb;?></td>
