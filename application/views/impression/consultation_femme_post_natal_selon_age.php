			...
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				...
				<tbody class="corps">
					...
					<tr> 
						...
						<td style="font-size:11.5px;" align="center"><?php $m15 = $this->md_patient->rapport_femme_poste_natal_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier);echo $m15->nb;$som_1+=$m15->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1517 = $this->md_patient->rapport_femme_poste_natal_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier);echo $f1517->nb;$som_2+=$f1517->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1835 = $this->md_patient->rapport_femme_poste_natal_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier);echo $f1835->nb;$som_3+=$f1835->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f36plus = $this->md_patient->rapport_femme_poste_natal_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier);echo $f36plus->nb;$som_4+=$f36plus->nb;?></td>
