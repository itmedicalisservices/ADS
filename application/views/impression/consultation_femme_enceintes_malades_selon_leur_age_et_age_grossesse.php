			...
			<table style="width:100%; font-size:12px" border="1" cellspacing="0">
				...
				<tbody class="corps">
					...
					<tr> 
						...
						<td style="font-size:11.5px;" align="center"><?php $m15Moins3 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,0,3);echo $m15Moins3->nb;$som_1+=$m15Moins3->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1517Moins3 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,0,3);echo $f1517Moins3->nb;$som_2+=$f1517Moins3->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1835Moin3 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,0,3);echo $f1835Moin3->nb;$som_3+=$f1835Moin3->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f36plusMoins3 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,0,3);echo $f36plusMoins3->nb;$som_4+=$f36plusMoins3->nb;?></td>


						<td style="font-size:11.5px;" align="center"><?php $m15Moins6 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,4,6);echo $m15Moins6->nb;$som_4+=$m15Moins6->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1517Moins6 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,4,6);echo $f1517Moins6->nb;$som_5+=$f1517Moins6->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1835Moins6 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,4,6);echo $f1835Moins6->nb;$som_6+=$f1835Moins6->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f36plusMoins6 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,4,6);echo $f36plusMoins6->nb;$som_7+=$f36plusMoins6->nb;?></td>

						
						<td style="font-size:11.5px;" align="center"><?php $m15Moins9 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,7,9);echo $m15Moins9->nb;$som_1+=$m15Moins9->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1517Moins9 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,7,9);echo $f1517Moins9->nb;$som_2+=$f1517Moins9->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f1835Moins9 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,7,9);echo $f1835Moins9->nb;$som_3+=$f1835Moins9->nb;?></td>
						<td style="font-size:11.5px;" align="center"><?php $f36plusMoins9 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,7,9);echo $f36plusMoins9->nb;$som_4+=$f36plusMoins9->nb;?></td>
				...
				<tfoot>
					<td style="font-size:11.5px;font-weight:bold">Total</td>
						...
						<td style="font-size:11.5px;" align="center"><?php echo $som_1+$som_2+$som_3+$som_4+$som_5+$som_6+$som_7+$som_8+$som_9+$som_10+$som_11+$som_12; ?></td>
