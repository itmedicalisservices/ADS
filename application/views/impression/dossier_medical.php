		 ...
		 <!-- Corps de reçu -->
			...
			<br>
				<div style="width:100%;" >
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						<thead align="center" style="background-color:rgb(167,206,0)">
							<th colspan="10">Gestation antérieur</th>
						</thead>		
						<tbody>
							<tr>
								<td align="center"><strong>Date </strong></td>
								...
								<td align="center"><strong>Nb enfant décédés </strong></td>
								<td align="center"><strong>Parité </strong></td>
								<td align="center"><strong>Antecedents obstétricaux</strong></td>
								<td align="center"><strong>Antecedents médicaux</strong></td>
								<td align="center"><strong>Antecedents chirurgicaux</strong></td>
								<td align="center"><strong>Antecedents gynécologiques</strong></td>
							</tr>
							<?php
								foreach($actes_medicaux_patient AS $id_sejours) {
										...
										foreach($gestation AS $c) { ?>
											<tr>
												...
												<td align="center"><?php echo $c->ges_iNb_enfant_decédes; ?></td>
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						<thead align="center" style="background-color:rgb(167,206,0)">
							<th colspan="10">Intérogatoire</th>
						</thead>		
						<tbody>
							<tr>
								<td align="center"><strong>Date </strong></td>
								...
								<td align="center"><strong>Leucorrhées</strong></td>
								<td align="center"><strong>Vomissements gravidiques</strong></td>
								<td align="center"><strong>Fièvre</strong></td>
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td align="center"><strong>Spéculum </strong></td>
								<td align="center"><strong>Col </strong></td>
								<td align="center"><strong>Annexes  </strong></td>
								<td align="center"><strong>Taille de l'utérus</strong></td>
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td align="center"><strong>TA </strong></td>
								<td align="center"><strong>Présentation siège</strong></td>
								...
								<td align="center"><strong>Oédemes + albuminerie</strong></td>
								<td align="center"><strong>Cerclage du col</strong></td>
								<td align="center"><strong>Présentation transverse à 17 moins ou plus</strong></td>
								<td align="center"><strong>Terme dépassé</strong></td>
							</tr>
							<?php
								foreach($actes_medicaux_patient AS $id_sejours) {
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								<td align="center"><strong>Date </strong></td>
								<td align="center"><strong>Methodes contraceptives adoptées </strong></td>
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td align="center"><strong>Présentation </strong></td>
								<td align="center"><strong>TA </strong></td>
								<td align="center"><strong>Poids  </strong></td>
					...
					<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td align="center"  rowspan="2"><strong>Déroulement de la grossesse</strong></td>
								<td align="center"  rowspan="2"><strong>Accouchement  </strong></td>
								<td align="center" colspan="5"><strong>Père </strong></td>
								<td align="center" colspan="5" ><strong>Mère  </strong></td>
								<td align="center" rowspan="2"><strong>Nombre de frère</strong></td>
								<td align="center" rowspan="2"><strong>Nombre de frère décédés</strong></td>
							</tr>
							<tr>
								<td align="center"><strong>Nom</strong></td>
								<td align="center"><strong>Prénom</strong></td>
								<td align="center"><strong>Profession</strong></td>
								<td align="center"><strong>Téléphone</strong></td>
								<td align="center"><strong>Adresse</strong></td>
								<td align="center"><strong>Nom</strong></td>
								<td align="center"><strong>Prénom</strong></td>
								<td align="center"><strong>Profession</strong></td>
					...
					<?php if($patient->pat_sSexe == "F") { ?>
						<table style="width:100%; height:50px; font-size:12px" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									<td align="center" rowspan="2"><strong>Date</strong></td>
									<td align="center" colspan="2"><strong>Acuité visuelle</strong></td>
									<td align="center" colspan="2"><strong>skiascopie</strong></td>
									<td align="center" colspan="2"><strong>Sphérique</strong></td>
