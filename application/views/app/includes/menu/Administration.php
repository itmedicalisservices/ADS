...
<li class="<?php if ($page == "parametre" AND $sousPage == "") {
			echo "active";
		} ?>"><a href="<?php echo site_url("parametre"); ?>"><i class="zmdi zmdi-settings"></i><span>Paramètres</span> </a>
</li>
<li class="<?php if ($sousPage == "classification_cim_10") {
			echo "active";
		} ?>"><a href="<?php echo site_url("parametre/classification_cim_10"); ?>"><i class="zmdi zmdi-menu"></i><span>Classification CIM-10</span> </a>
</li>
