	...
	<nav class="navbar clearHeader">
		<div class="col-12">
			...
			<ul class="nav navbar-nav navbar-left" style="">
				<a class="navbar-brand" href="<?php echo site_url("app"); ?>">== ÉPIPHANIE - LOGICIEL DE GESTION HÔSPITALIÈRE ==</a>
			</ul>
		</div>
	</nav>
	<!-- #Top Bar -->
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				...
				<div class="admin-action-info"> <span><?php echo $user->per_sTitre; ?> <?php echo $user->per_sNom . ' ' . $user->per_sPrenom; ?><br><?php echo $user->ser_sLibelle; ?></span>
					<ul>
