															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="hyp" style="width:100%;padding-bottom:5px;padding-top:5px" class="obligatoire selectDia">
															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="ret" style="width:100%;padding-bottom:5px;padding-top:5px" class="obligatoire selectDia">
																			<option value=""> Sélectionner * </option>
																			<?php foreach($listeMaladieDia AS $lm){?>
													...
													<tr>
														<td>
															<select id="act_imagerie" style="width:100%;padding-bottom:5px;padding-top:5px" class="select2">
																<option value=""> Prescription * </option>
																<?php $listeActSoins = $this->md_parametre->liste_prescription(6); foreach($listeActSoins AS $li){?>
																<option value="<?php echo $li->lac_id; ?>-/-<?php echo $li->lac_sLibelle; ?>-/-<?php echo $li->uni_id; ?>-/-<?php echo $li->lac_iDure; ?>"> <?php echo $li->lac_sLibelle; ?> </option>
																<?php } ?>
															</select>
															
															<?php  //var_dump($listeActSoins[0]); ?>
														</td>
