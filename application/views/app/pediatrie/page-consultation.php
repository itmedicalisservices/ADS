                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:13.5px">
							...
							<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Dne"><b>Déclaration Decès du nouveau né</b></a></li>
                        ...
                        <div class="tab-content">
									...
									<form id="form-c">
										...
										<div class="row clearfix">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Poids / Taille (%) </label>
														<textarea class="form-control " rows="10" name="PT"><?php if($consultation){echo $consultation->csl_sResume ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Prérimetre Braquiale (cm)</label>
														<textarea class="form-control " rows="10" name="PB"><?php if($consultation){echo $consultation->csl_sResume ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Présence d’oedème</label>
														<select  style="width:100%;padding-bottom:5px;padding-top:5px" class="form-control" name="oedeme">
															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="hyp" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectDia obligatoire">
																			<option value=""> Sélectionner * </option>
																			<?php foreach($listeMaladieDia AS $lm){?>
																				
																				<?php $liste_sm1=$this->md_parametre->recup_sm1_maladie($lm->mal_id);  ?>
																				<?php if(count($liste_sm1)>0){ ?>
																					<?php foreach($liste_sm1 AS $sm1){ ?>
																						<?php $liste_sm2=$this->md_parametre->recup_sm2_sm1($sm1->sm1_id);  ?>
																						<?php if(count($liste_sm2)>0){ ?>
																							<?php  foreach($liste_sm2 AS $sm2){ ?>
																								<option value="<?php echo $lm->mal_id.'+/+'.$sm1->sm1_id.'+/+'.$sm2->sm2_id; ?>-/-<?php echo $sm2->sm2_sLibelle; ?>"> <?php echo $sm2->sm2_sLibelle; ?></option>
																							<?php } ?>
																						<?php }else{ ?>
																							<option value="<?php echo $lm->mal_id.'+/+'.$sm1->sm1_id.'+/+'.''; ?>-/-<?php echo $sm1->sm1_sLibelle; ?>"> <?php echo $sm1->sm1_sLibelle; ?></option>
																						<?php } ?>
																					<?php } ?>
																				<?php }else{ ?>
															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="ret" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectDia obligatoire">
																			<option value=""> Sélectionner * </option>
																			<?php foreach($listeMaladieDia AS $lm){?>
													...
													<tr>
														<td>
															<select id="act_reeducation" style="width:100%;padding-bottom:5px;padding-top:5px" class="select2">
																<option value=""> Prescription * </option>
																<?php $listeActSoins = $this->md_parametre->liste_prescription(8); foreach($listeActSoins AS $li){?>
																<option value="<?php echo $li->lac_id; ?>-/-<?php echo $li->lac_sLibelle; ?>-/-<?php echo $li->uni_id; ?>-/-<?php echo $li->lac_iDure; ?>"> <?php echo $li->lac_sLibelle; ?> </option>
																<?php } ?>
															</select>
														</td>														
							...
							<div role="tabpanel" class="tab-pane" id="Dne">
                                <div class="header" style="margin-top:45px">
									<h2>Déclaration nouveau né <small>renseignez tous les champs marqués par des (*)</small> </h2>
								</div>
								...
								<div class="body">
									...
									<div class="col-sm-12 retour-new-ne"></div>
										...
										<div class="row clearfix">
											...
											<div class="col-sm-12">
												<a class="btn btn-raised bg-blue-grey" id="DecesNouveauNe">Enregistrer</a>
											</div>
										</div>
									</form>
								</div>
