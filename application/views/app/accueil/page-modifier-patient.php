													...
													<div class="body">
														<form id="form-edit-pat">
																...
																<!--<div class="col-sm-4">
																	<div class="form-group drop-custum">
																		...
																		<select name="civilite" class="form-control obligatoire show-tick">
																			<option value="M." <?php //if($patient->pat_sCivilite=="Mr"){echo "selected='selected'";} ?>>Monsieur</option>
															...
															<div class="row clearfix">
																...
																<!--<div class="col-sm-3">
																	<div class="form-group drop-custum">
																		<label>Patient conventionné</label>
																		<select name="cpa" class="form-control show-tick">
																		<?php //if($patient->cpa_id!=0){?>
																			<?php// foreach($liste AS $l){?>
																				<option value="">-- le patient n'est plus conventionné --</option>
																				<option value="<?php //echo $l->cpa_id;?>" <?php //if($l->cpa_id==$patient->cpa_id){echo 'selected="selected"';};?>><?php //echo $l->cpa_sEnseigne;?></option>
																			<?php //};?>
																		<?php// }else{?>
																			<option value="">-- sélectionner l'entreprise --</option>
																			<?php //foreach($liste AS $l){?>
																				<option value="<?php //echo $l->cpa_id;?>"><?php //echo $l->cpa_sEnseigne;?></option>
																			<?php //};?>
																		<?php //}?>
																		</select>
																	</div>
