								...
								<table  id="" class="table table-bordered table-striped table-hover">
									...
									<?php foreach($liste AS $l){ ?>
										<tr>
											...
											<td><a href="<?php echo site_url("patient/voir/".$l->pat_id); ?>"><?php echo $l->pat_sPrenom; ?> </a> </td>
											...
											<td>
												<a onclick="return confirm('Confirmez-vous la suppression de ce patient ?');" href="<?php echo site_url("patient/supprimer_patient/".$l->pat_id);?>" class=""><i class="zmdi zmdi-delete text-danger"></i></a>
											&nbsp;&nbsp; 
												<a href="<?php echo site_url("patient/modifier/".$l->pat_id); ?>" class="" title="Modifier"><i class="zmdi zmdi-edit"></i></a> 
											&nbsp;&nbsp;
											<a href="<?php echo site_url("patient/voir/".$l->pat_id); ?>" class="" title="Voir détails"><i class="fa fa-eye text-success"></i></a></td>
										</tr>
									<?php } ?>
									</tbody>
								</table>
