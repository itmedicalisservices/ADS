																				...
																				<td colspan="4">
																					<select name="acte" style="width:100%;padding:10px" id="acte" class="acte select2 obligatoire show-tick">
																						...
																						<optgroup style="font-size:16px" label="<?php echo $s->ser_sLibelle; ?>">
																							<?php if($s->ser_id==22){$NumChirurgi = $this->md_parametre->recup_act(65)?>
																								<option value="<?php echo $NumChirurgi->lac_id; ?>-/-<?php echo ucfirst($NumChirurgi->lac_sLibelle); ?>"><?php echo ucfirst($NumChirurgi->lac_sLibelle); ?></option>
																							<?php 
																							}else{?>
																					...
																					<input style="" type="hidden" name="" id="idFlt" />
																				</td>
																				<td>
...
<div class="modal fade" id="mdModalOrientation" tabindex="-1" role="dialog">
  ...
  <script type="text/javascript">
        ...
        function addDetail() 
        {
            ...
            var idFlt 	            = document.getElementById('idFlt').value;
        ...
        function showListe() 
        {
            ...
            for(var i = 0; i < tailleTableau; i++) {
                ...
                contenu += '<td><input type="hidden" name="ser[]" value="'+ annuaire[i].idSer+'"/>  <input type="hidden" name="flt[]" value="'+ annuaire[i].idFlt+'"/>' + annuaire[i].ser + '</td>';
