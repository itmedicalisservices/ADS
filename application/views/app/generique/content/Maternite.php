...
<?php 
	...
	$listeEncours = $this->md_patient->liste_acm_encours_attent_demande(date("Y-m-d H:i:s"),$user->ser_id);
            ...
            <div role="tabpanel" class="tab-pane active in" id="income">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="card">
							<div class="header">
								<h2>Les patients en attente en maternit�</h2>
							</div>
								...
								<table id="example1" class="table table-bordered table-striped table-hover">
									...
									<?php foreach($listeEncours AS $le){ ?>
										<tr>
											...
											<td class="text-center">
												<a rel="<?php echo $le->acm_id."-/-".$le->pat_id;?>" class="maternite" href="javascript:();"><b>DEMANDE</b><br><b>D'HOSPITALISATION</b></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
						...
						<div class="body table-responsive">
							<form id="form-demande">
									...
									<div class="col-sm-12">
										<div class="form-line">
											...
											<div class="form-group drop-custum">
												...
												<input type="hidden" id="pat" name="pat">
								...
								<div class="row clearfix">
									...
									<div class="col-sm-12">
										<button type="submit" class="btn btn-raised bg-blue-grey" id="enregistrerDemandeMAT">VALIDER</button>
									</div>
								</div>
							</form>
						</div>
