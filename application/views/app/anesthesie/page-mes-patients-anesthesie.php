...
<?php 	
$listeApres = $this->md_patient->liste_acm_encours(date("Y-m-d H:i:s"),$this->session->ititmedicalis);
 $liste = $this->md_chirurgie->liste_acm_mes_anesth_encours(date("Y-m-d H:i:s"),$this->session->ititmedicalis);
 ?>
