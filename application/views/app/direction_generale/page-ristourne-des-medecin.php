...
<section class="content home" style="min-height:700px">
    ...
    <div class="container-fluid">
					...
					<div class="body">
						<form id="stat-prescripteur">
							<div class="row clearfix">
								...
								<div class="col-sm-2">
								<br><br>
									<button type="submit" class="btn btn-raised bg-blue-grey" id="SoldePresc">Valider</button>
								</div>
							</div>
						</form>
					</div>
        ...
        <div class="row clearfix" id="afficheSolde">
							...
							<table id="example" class="table table-hover">
								<thead>
									<tr>
										...
										<th style="width:60%;">Médecin</th>
										<th style="width:20%;">Solde (fcfa)</th>
								...
								<tbody>
									...
									<?php $Total +=$montant->montant; ?>
									<tr>
										<td><?php echo $a->pre_sTitre?></td>
										<td><?php echo $a->pre_sNom.' '.$a->pre_sPrenom; ?></td>
										<td><?php echo number_format($montant->montant,0,",","."); ?></td>
										<td class="text-center"><a href="<?php echo site_url("statistique/detail_ristourne/".$a->pre_id);?>"><i class="fa fa-eye"></i></a></td>
									</tr>
