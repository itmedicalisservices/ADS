			...
			<div class="row clearfix" >
			 <!--   <div class="col-lg-6 col-md-6 col-sm-6">
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						<div class="header">
							<h2><?php echo $a->pre_sTitre?> <?php echo $a->pre_sNom.' '.$a->pre_sPrenom; ?></h2>
							(<a href="<?php echo site_url("Impression/ristourne/".$a->pre_id."--".date("Y-m-d")."--".date("Y-m-d"));?>" align="right" type="submit" class=" m-1">Imprimer</a>)
						</div>
						<div class="body">
							<div class="table-responsive">
								<table id="example" class="table table-hover">
									...
									<tbody>
										...
										<?php $liste = $this->md_patient->liste_prescriptions($a->pre_id,date("Y-m-d"),date("Y-m-d")); ?>
										...
										<tr>
											...
											<td><?php echo $montant_presc; ?> FCFA</td>
										</tr>
										<tr>
											<td colspan="3" align="right"><strong>Ristourne :</strong></td>
											<td><?php echo number_format($montant->montant,0,",","."); ?> FCFA</td>
										</tr>
										<?php }else{ ?>
										<tr>
