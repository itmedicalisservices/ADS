									...
									<form id="form-ope">
										<div class="row">
											...
											<div class="col-sm-4">
												...
												<div class="form-group">
													<div class="form-line">
														<select name="acte" class="obligatoire select2"  style="width:100%;padding-bottom:5px;padding-top:5px">
														<option value="">----- Acte chirurgical * -----</option>
														<?php $acte = $this->md_parametre->liste_prescription(9); foreach($acte AS $a){if($a->lac_id != 65){ ?>
												...
												<div class="form-group">
													<div class="form-line">
														<select name="bloc" id="bloc" class="obligatoire selectBloc" style="width:100%;padding-bottom:5px;padding-top:5px" >
												...
												<div class="body table-responsive">
													<table class="table table-bordered table-striped table-hover">
														<thead>
															...
															<tr>
																<td>
																	<select id="agent" name="personnel" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectAgent">
										...
										<div class="row clearfix">
											...
											<div class="col-sm-6">
												<div class="form-line">
													<label style="color:#000"><b>Unité *</b></label>
													<div class="form-group drop-custum">
														<select name="uni" class="form-control unitePresc obligatoire show-tick" class="selectUni">
															<option value="">------------ Choisir l'unité --------------</option>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Unité *</label>
														<select name="unite" class="form-control obligatoire" class="selectUni">
															<option value="">--------- Selectionner ----------</option>
