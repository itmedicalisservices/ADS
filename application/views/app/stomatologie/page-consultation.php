			...
			<div class="body"> 
				...
				<ul class="nav nav-tabs" role="tablist" style="font-size:14px">
				 ...
				 <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
					...
					<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#enfant"><b <?php if($patient->pat_iEnfant==1){echo 'style="color:red"';}else{echo '';} ;?>><?php if($patient->pat_iEnfant==1){echo 'Enfant malnutri(e)';}else{echo 'Déclaration enfant malnutri(e)';} ;?></b></a></li>Tab panes -->
								...
								<table class="table table-bordered table-striped table-hover">
									...
									<thead>
										...
										<?php 
											...
											$consultationStoma_sejour = $this->md_patient->consultationStoma_sejour($l->sea_id);
										...
										<tr>
											...
											<td colspan="2">
												<table style="width:100%;padding:0">
													...
													<?php if($consultationStoma_sejour){ ?>
													<tr>
														<td>Consultation</td>
														<td style="width:17.6%">
															<a href="javascript:();" rel="<?php echo $l->sea_id;  ?>" class="text-info consuStoma_sej" style="color:#fff"><i class="fa fa-arrow-right pull-right" style="font-size:25px"></i></a>
														</td>
													</tr>
													<?php } ?>
