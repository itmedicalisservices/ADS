                    ...
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
						 ...
						 <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
                            ...
                            <!-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#imagerie" id="in"><b>Examen imagerie</b></a></li>Tab panes -->
                           ...
                           <!--  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reeducation"><b>Rééducation</b></a></li>Tab panes -->
                        </ul>	 
															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="hyp" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectDia">
															...
															<thead>
																...
																<tr>
																	<td>
																		...
																		<select id="ret" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectDia">
																			<option value=""> Sélectionner * </option>
																			<?php foreach($listeMaladieDia AS $lm){?>
