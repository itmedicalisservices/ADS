...
<?php $liste = $this->md_parametre->liste_typeacte_100(); ?>


<?php $NBtypeacte = $this->md_parametre->nb_typeacte_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Libellé & Quotes-parts (<?php echo $NBtypeacte; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_typeacte"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_typeacte").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_typeacte").html(retour);
					}
