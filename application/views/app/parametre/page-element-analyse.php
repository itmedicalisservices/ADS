...
<?php $liste = $this->md_parametre->liste_element_analyse_100(); ?>

<?php $NBelementAnalyse = $this->md_parametre->nb_element_analyse_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Liste des elements à analyser(<?php echo $NBelementAnalyse; ?>) </h2>
						...
						<button style="" type="button" class="btn bg-blue-grey waves-effect ajout_element pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                        
                    </div>
                    <div class="body table-responsive liste_element_analyse"> 
								...
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<?php //var_dump($liste)?>
											...
											<td>
												<select id="tex" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectTex show-tick">
											...
											<td>
												<select id="lac" style="width:100%;padding-bottom:5px;padding-top:5px" class="select2 show-tick">
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_element_analyse_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_element_analyse").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_element_analyse").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_element_analyse_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
