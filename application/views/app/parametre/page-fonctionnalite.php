...
<?php $liste = $this->md_parametre->liste_fonctionnalite_100(); ?>

<?php $NBfonctionnalite = $this->md_parametre->nb_fonctionnalite_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des fonctionnalités(<?php echo $NBfonctionnalite; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_fonctionnalite"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_fonctionnalite_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_fonctionnalite").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_fonctionnalite").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_fonctionnalite_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
