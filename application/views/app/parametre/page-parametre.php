            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number"><?php echo $this->md_parametre->nb_services_actifs()->nb;?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
           ...
           <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number"><?php echo $this->md_parametre->nb_acte_medical()->nb;?></div>
                    </div>
                </div>
            </div>
			<div class="col-lg-4 col-md-4 col-sm-6">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("rapport/liste_equipement");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Equipement</div>
                        <div class="number"><?php echo count($this->md_patient->liste_materiel());?></div>
                    </div>
                </div>
            </div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/prescripteur");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Préscripteurs</div>
                        <div class="number"><?php echo count($this->md_parametre->liste_prescripteur_actifs());?></div>
                    </div>
                </div>
            </div>
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/quotes_parts");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Quotes-parts du personnels</div>
                        <div class="number"><?php echo count($this->md_parametre->liste_quotes_parts_actifs());?></div>
                    </div>
                </div>
            </div>  
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/motif_fin_hospitalisation");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Motifs de fin d'hospitalmisation</div>
                        <div class="number"><?php echo $this->md_parametre->nb_motifs_fin_hospitalisation()->nb;?></div>
                    </div>
                </div>
            </div>  
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/antecedent_obs");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Antécédents obstetricaux</div>
                        <div class="number"><?php echo $this->md_smi->nb_antecedant_Lob()->nb;?></div>
                    </div>
                </div>
            </div> 
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/source");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Source d'information</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"><a href="<?php echo site_url("parametre/vaccin");?>"><i class="zmdi zmdi-settings col-blue-grey"></i><br>Administrer</a></div>
                    <div class="content">
                        <div class="text">Vaccin</div>
                        <div class="number"><?php echo $this->md_smi->nb_vaccin_info()->nb;?></div>
                    </div>
                </div>
            </div>
