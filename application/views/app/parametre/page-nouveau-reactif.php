...
<?php $list = $this->md_parametre->liste_reactif_100(); ?>


<?php $NBreactif = $this->md_parametre->nb_reactif_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des réactifs(<?php echo $NBreactif ;?>) </h2>
                        ...
                        <button style="" type="button" class="btn bg-blue-grey waves-effect ajout_reactif pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b> Noveau réactif</b></button>
						
                    </div>
                    <div class="body table-responsive liste_reactif"> 
												...
												<form id="form-cou">
													<table class="table table-bordered table-striped table-hover">
														<thead>
															...
															<tr>
																<td>
																	<select id="lacId" style="width:100%;padding-bottom:5px;padding-top:5px"class=" selectReact show-tick">
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_reactif").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_reactif").html(retour);
					}
