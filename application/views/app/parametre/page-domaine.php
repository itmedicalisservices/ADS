...
<?php $liste = $this->md_parametre->liste_postes_100(); ?>
<?php $NBposte = $this->md_parametre->nb_postes_actifs(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des domaines professionnels (<?php echo $NBposte->nb ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_domaine pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                    ...
                    <div class="body table-responsive liste_poste"> 
								...
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											...
											<td>
												<select id="tpe" style="width:100%;padding-bottom:5px;padding-top:5px" class="selecttypePer">
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_poste").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_poste").html(retour);
					}
