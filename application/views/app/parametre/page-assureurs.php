...
<?php $liste = $this->md_parametre->liste_assurance_100(); ?>
<?php $NBassurance = $this->md_parametre->nb_assurance_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des assureurs enregistrés(<?php echo $NBassurance; ?>)</h2>
                        <br><input type="text" name="search" id="search1" placeholder="Recherche ..." style="width:70%;padding-left:1%;margin-left:1%" oninput="recherche1()" />
                    ...
                    <div class="body table-responsive liste_assurance"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_assurance").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_assurance").html(retour);
					}
