...
<?php $liste = $this->md_parametre->liste_specification_100(); ?>


<?php $NBspecificiation = $this->md_parametre->nb_specification_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Classification des maladies par spécificité(<?php echo $NBspecificiation; ?>) </h2>
						...
						<button style="" type="button" class="btn bg-blue-grey waves-effect ajout_specification pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter</b></button>
                        
                    </div>
                    <div class="body table-responsive liste_specification"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_specification_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_specification").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_specification").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_specification_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
