...
<?php $liste = $this->md_parametre->liste_unites_100(); ?>
<?php $NBunite  = $this->md_parametre->nb_unite_actifs(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des unités de l'hôpital (<?php echo $NBunite->nb ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_unite pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                    ...
                    <div class="body table-responsive liste_unites"> 
							...
							<form id="form-uni">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											<td>
												<select id="dir" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectDir show-tick">
											...
											<td>
												<select id="serv" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectSer show-tick">
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 alert(retour);
					if(retour == ""){
						$(".liste_unites").html('<tr><td colspan="4"><em>Aucun service trouver</em></td></tr>');
					}else{
						$(".liste_unites").html(retour);
					}
