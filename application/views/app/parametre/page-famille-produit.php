...
<?php $liste = $this->md_parametre->liste_famille_produit_100(); ?>

<?php $NBfamille_pro = $this->md_parametre->nb_famille_produit_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des familles des produits(<?php echo $NBfamille_pro;?>)</h2>
                    ...
                    <div class="body table-responsive liste_famille_produit"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_famille_produit_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_famille_produit").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_famille_produit").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_famille_produit_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
