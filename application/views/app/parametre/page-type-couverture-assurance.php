...
<?php $liste = $this->md_parametre->liste_couverture_100(); ?>
<?php $NBcouverture = $this->md_parametre->nb_couverture_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des types de couvertures d'assurances hôpitalières(<?php echo $NBcouverture; ?>) </h2>
                    ...
                    <div class="body table-responsive liste_couverture">
												...
												<form id="form-cou">
													<table class="table table-bordered table-striped table-hover">
														<thead>
															...
															<tr>
																<td>
																	<select id="lacId" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectAcm">
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_couverture").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_couverture").html(retour);
					}
