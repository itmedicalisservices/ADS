...
<?php $NBfonction = $this->md_parametre->nb_fonctions_actifs(); ?>
<?php $liste = $this->md_parametre->liste_fonctions_100(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des postes hospitalièrs (<?php echo $NBfonction->nb ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_poste pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                    ...
                    <div class="body table-responsive liste_fonction"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_fonction").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_fonction").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_fonction_list_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
