...
<?php $liste = $this->md_parametre->liste_type_fournisseur_100(); ?>


<?php $NBtypefournisseur= $this->md_parametre->nb_type_fournisseur_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des types de fournisseurs(<?php echo $NBtypefournisseur; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_type_fournisseur"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_type_fournisseur_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_type_fournisseur").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_type_fournisseur").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_type_fournisseur_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
