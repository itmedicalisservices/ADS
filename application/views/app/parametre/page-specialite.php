...
<?php $liste = $this->md_parametre->liste_specialites_100(); ?>
<?php $NBspecialite = $this->md_parametre->nb_specialites_actifs(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des spécialités hospitalières (<?php echo $NBspecialite->nb ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_specialite pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                    ...
                    <div class="body table-responsive liste_specialite"> 
							...
							<form id="form-spe">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											<td>
												<select id="typePer" style="width:100%;padding-bottom:5px;padding-top:5px"  class="selecttypePer">
											...
											<td>
												<select id="domaine" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectdomaine">
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_specialite").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_specialite").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_specialite_list_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
