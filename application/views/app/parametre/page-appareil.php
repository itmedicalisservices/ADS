...
<?php $liste = $this->md_parametre->liste_appareil_100(); ?>


<?php $NBappareil = $this->md_parametre->nb_appareil_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Liste des appareils(<?php echo $NBappareil; ?>) </h2>
                    ...
                    <div class="body table-responsive liste_appareil"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_appareil").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_appareil").html(retour);
					}
