...
<?php $liste = $this->md_parametre->liste_antecedent_familial_100(); ?>


<?php $NBantecedentfam = $this->md_parametre->nb_antecedent_familial_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des antécédents familiaux(<?php echo $NBantecedentfam; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_antecedent_familial"> 
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_antecedent_familial_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_antecedent_familial").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_antecedent_familial").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_antecedent_familial_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
