...
<?php $liste = $this->md_parametre->liste_acte_divers_100(); ?>
<?php $NBactedivers = $this->md_parametre->nb_acte_divers_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des actes/frais divers (<?php echo $NBactedivers ;?>)</h2>
						...
						<button style="" type="button" class="btn bg-blue-grey waves-effect ajout_divers pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter </b></button>
                    </div>
                    <div class="body table-responsive  liste_acte_divers"> 
								...
								<table class="table table-bordered table-striped table-hover" id="example">
									<thead>
										...
										<tr>
											...
											<td>
												<select class="obligatoire selecttya" name="tya" id="" style="padding-bottom:5px;padding-top:5px">
											...
											<td>
												<select class="obligatoire selectuni" name="uni" id="" style="padding-bottom:5px;padding-top:5px" >
											...
											<td class="text-center">
												<select name="check" id="" class="obligatoire selectcheck" style="padding-bottom:5px;padding-top:5px" >
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_acte_divers_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_acte_divers").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_acte_divers").html(retour);
					}
