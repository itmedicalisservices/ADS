...
<?php $liste = $this->md_parametre->liste_allergie_100(); ?>


<?php $NBallergie = $this->md_parametre->nb_allergie_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des allergies(<?php echo $NBallergie; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_allergie"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_allergie").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_allergie").html(retour);
					}
