...
<?php 
	...
	/* Personnel medical */
	$articleTotaux  = $this->md_parametre->nb_services_actifs();
	...
	$liste = $this->md_parametre->liste_services_100();
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des services de l'hôpital (<?php echo $articleTotaux->nb ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_service pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
                    ...
                    <div class="body table-responsive " style="overflow:auto;height:500px" id="service_table">
								...
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											...
											<td>
												<select id="dep" style="width:100%;padding-bottom:5px;padding-top:5px;" class="selectDir show-tick" name="dep">
											...
											<td>
												<select id="flt" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectFonc show-tick" name="flt">
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					//alert(retour);
					if(retour == ""){
						$("#service_table").html('<tr><td colspan="4"><em>Aucun service trouver</em></td></tr>');
					}else{
						$("#service_table").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_service_list_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
