...
<?php $liste = $this->md_parametre->liste_chambre_100(); ?>

<?php $NBchambre = $this->md_parametre->nb_chambre_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Les chambres et les lits(<?php echo $NBchambre; ?>) </h2>
						...
						<button style="" type="button" class="btn bg-blue-grey waves-effect ajout_chambre pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter une nouvelle</b></button>
                        
                    </div>
                    <div class="body table-responsive liste_chambre"> 
							...
							<form id="form-chambre">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											<td>
												<select id="serCh" style="width:100%;padding-bottom:7px;padding-top:7px"  class="selectSer show-tick">
											...
											<td>
												<select id="uni" style="width:100%;padding-bottom:7px;padding-top:7px" class="selectUni show-tick">
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_chambre").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_chambre").html(retour);
					}
