    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">Les Blocs opératoires et les salles d'opérations </h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_bloc pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter une nouvelle</b></button>
							...
							<form id="form-bloc">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											<td>
												<select id="serCh" style="width:100%;padding-bottom:7px;padding-top:7px" class="selectserCh">
											...
											<td>
												<select id="uni" style="width:100%;padding-bottom:7px;padding-top:7px" class="selectuni">
