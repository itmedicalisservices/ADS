...
<?php 
	...
	/* Personnel medical */
	$articleTotaux  = $this->md_parametre->nb_acte_medical()->nb;
	...
	$liste = $this->md_parametre->liste_actes_medicaux_100();
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class=" pull-left">liste des actes médicaux de l'hopital (<?php echo $articleTotaux ;?>)</h2><button style="" type="button" class="btn bg-blue-grey waves-effect ajout_acm pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouvel acte</b></button>
                    ...
                    <div class="body table-responsive" style="overflow:auto;height:500px" id="acte_table"> 
								...
								<table class="table table-bordered table-striped table-hover">
									<thead>
										...
										<tr>
											...
											<td>
												<select id="ser" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectSer show-tick">
											...
											<td>
												<select id="uni" style="width:100%;padding-bottom:5px;padding-top:5px" class="selectUni show-tick">
													<option value="">----- sélectionner * -----</option>
											...
											<td>
												...
												<select id="tya" style="width:100%;padding-bottom:5px;padding-top:5px" class="selecttya">
												<option value="">----- sélectionner * -----</option>
												<?php foreach($listetype AS $t){ ?>
   ...
   /* $( document ).ready(function() {
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				$.ajax({
					type:"POST",
					url: recherche_actes_medicaux_list,
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$("#acte_table").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$("#acte_table").html(retour);
					}
		...
		function recherche1(){
			...
			if($("#search1").val() ==""){
				...
				$.ajax({
					type:"POST",
					url: recherche_actes_medicaux_100,
					data:"search="+$("#search1").val(),
					async:true,
					error:function(xhr, status, error){
						alert(xhr.responseText);
