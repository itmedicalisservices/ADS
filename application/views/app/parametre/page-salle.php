...
<?php $liste = $this->md_parametre->liste_salle_100(); ?>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="body table-responsive liste_salle"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_salle").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_salle").html(retour);
					}
