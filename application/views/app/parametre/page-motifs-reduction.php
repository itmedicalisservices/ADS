...
<?php $liste = $this->md_parametre->liste_motifs_100(); ?>

<?php $NBmotif = $this->md_parametre->nb_motifs_actifs()->nb; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>liste des motifs de réduction(<?php echo $NBmotif; ?>)</h2>
                    ...
                    <div class="body table-responsive liste_motifs"> 
		...
		function recherche(){
			...
			if($("#search1").val() !=""){
				...
				.done(function(retour){
					 //alert(retour);
					if(retour == ""){
						$(".liste_motifs").html('<tr><td colspan="4"><em>Aucune specialite trouver</em></td></tr>');
					}else{
						$(".liste_motifs").html(retour);
					}
