                    ...
                    <div class="body table-responsive"> 
						<table id="example" class="table table-bordered table-striped table-hover" style="font-size:12px">
							...
							<?php foreach($liste AS $l){ ?>
								<?php $TotalMont +=$l->fac_iMontant; ?>
								<?php $TotalPaye+=$l->fac_iMontantPaye; ?>
								<?php $TotalAss+=$l->fac_iMontantAss; ?>
								<?php $TotalRes+=$l->fac_iReste; ?>
								<tr>
									<td>
							...
							<tfoot>
									<tr>
										...
										<th >
											<strong><?php echo $TotalMont; ?> FCFA</strong>
										</th>
										<th >
											<strong><?php echo $TotalPaye; ?> FCFA</strong>
										</th>
										<th >
											<strong><?php echo $TotalAss; ?> FCFA</strong>
										</th>
										<th >
											<strong><?php echo $TotalRes; ?> FCFA</strong>
										</th>
										<th >
