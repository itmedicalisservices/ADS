...
<?php $listeNouveauNe = $this->md_patient->recup_patient_NouveauNe($acm->pat_id); ?>


<?php $Examen_clinique = $this->md_smi->recup_Examen_clinique($acm_id); ?>
                    ...
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
						 ...
						 <!-- Nav tabs <ul class="nav nav-tabs" role="tablist" style="font-size:14px">
							...
							<!-- Nav tabs <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#imagerie" id="in"><b>Examen imagerie</b></a></li>
                        ...
                        <div class="tab-content">
												...
												<tr>
													...
													<td colspan="2">
														<table style="width:100%;padding:0">
															...
															<?php } ?>
															<?php if($Examen_clinique_sejour){ ?>
															<tr>
																<td>Examen clinique</td>
																<td style="width:17.6%">
																	<a href="javascript:();" rel="<?php echo $l->sea_id;  ?>" class="text-info examen_clinique_sej" style="color:#fff"><i class="fa fa-arrow-right pull-right" style="font-size:25px"></i></a>
																</td>
															</tr>
															<?php } ?>
															...
															<tr>
																<td>Partogramme</td>
																<td style="width:17.6%">
																	<a href="javascript:();" rel="<?php echo $l->sea_id;  ?>" class="text-info Partogramme_sej" style="color:#fff"><i class="fa fa-arrow-right pull-right" style="font-size:25px"></i></a>
																</td>
															</tr>
															<?php } ?>
							...
							<div role="tabpanel" class="tab-pane" id="Partogramme">
								...
								<div class="body">
									<form id="form-partogramme">
										...
										<div class="row clearfix">
											<div class="col-sm-12">
												<button type="submit" class="btn btn-raised bg-blue-grey" id="addPartogramme">Enregistrer</button>
											</div>
										</div>
									</form>
								</div>
							...
							<div role="tabpanel" class="tab-pane" id="Examen_clinique">
                                  <div class="header" style="margin-top:45px">
									<h2>Examen clinique <small>renseignez tous les champs marqués par des (*)</small> </h2>
									
								</div>
								<div class="body">
									<form id="form-examen">
										<div class="col-sm-12 retour-examen"></div>
										<div class="row clearfix">
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Motif de consultation *</label>
														<textarea class="form-control obligatoire" rows="10" name="motif"><?php if($Examen_clinique){echo $Examen_clinique->exa_sMotif ;}?></textarea>
														<input type="hidden" value="<?php echo $acm_id; ?>" name="id">
														<input type="hidden" value="<?php echo $patient->pat_id; ?>" name="pat">
													</div>
												</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
														<label style="color:#000">Antécedant medicaux</label>
														<textarea class="form-control " rows="10" name="medi"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAnt_medicaux ;}?></textarea>
													</div>
												</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Antécedant chirurgicaux</label>
														<textarea class="form-control " rows="10" name="chir"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAnt_chirurgicaux ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Antecedents obstétricaux</label>
														<textarea class="form-control " rows="10" name="obs"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAnt_obs ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Antecedents gynécologiques</label>
														<textarea class="form-control " rows="10" name="gyne"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAnt_gyneco ;}?></textarea>
													</div>
												</div>
											</div>	
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">PTME</label>
														<textarea class="form-control " rows="10" name="PTME"><?php if($Examen_clinique){echo $Examen_clinique->exa_sPTME ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">DDR</label>
														<textarea class="form-control " rows="10" name="DDR"><?php if($Examen_clinique){echo $Examen_clinique->exa_sDDR ;}?></textarea>
													</div>
												</div>
											</div>											
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Amnanèse</label>
														<textarea class="form-control " rows="10" name="amnanese"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAmnanese ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">TP</label>
														<textarea class="form-control " rows="10" name="TP"><?php if($Examen_clinique){echo $Examen_clinique->exa_sTP ;}?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<div class="form-line">
													<label style="color:#000">Examen</label>
														<textarea class="form-control " rows="10" name="examen"><?php if($Examen_clinique){echo $Examen_clinique->exa_sExamen ;}?></textarea>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Conclusion</label>
														<textarea class="form-control " rows="10" name="conclusion"><?php if($Examen_clinique){echo $Examen_clinique->exa_sConclusion ;}?></textarea>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label style="color:#000">Accouchement</label>
														<textarea class="form-control " rows="10" name="accouchement"><?php if($Examen_clinique){echo $Examen_clinique->exa_sAccouchement ;}?></textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row clearfix">
											<div class="col-sm-12">
												<button type="submit" class="btn btn-raised bg-blue-grey" id="addExamen">Enregistrer</button>
											</div>
										</div>
									</form>
								</div>
							...
							<div role="tabpanel" class="tab-pane" id="ne">
								...
								<div class="card">
									<div class="header">
										<h2>Liste des Nouveaus nés</h2>
										<button style="" type="button" class="btn bg-blue-grey waves-effect ajout_unite pull-right" style="color:#fff"><i class="fa fa-plus"></i> <b>Ajouter un nouveau</b></button>
									</div>
									<div class="body table-responsive" id="dossier">
										<table id="example" class="table table-bordered table-striped table-hover">
											<thead>
												<tr>
													<th>Sexe du nouveau né</th>
													<th>Date Naiss</th>
													<th>Heure Naiss</th>
											...
											<tbody>
											<?php foreach($listeNouveauNe AS $le){ ?>
												<tr style="<?php if(!is_null($le->nne_dDateDeces)){ echo 'color: red'; } ?>;" >
													<td><?php  if($le->nne_sSexe == "M"){ echo "Masculin"; }else{ echo "Feminin"; } ?> </td>
													<td><?php echo $this->md_config->dateEN2FR($le->nne_dDateNaiss); ?></td>
													<td><?php echo $le->nne_tHeureNaiss; ?></td>
													<td><?php  if($le->nne_iTypeGro == 1){ echo "Mono-foetal"; }else{ echo "Gémelaire"; } ?></td>
													<td class="text-center">
													<?php if(is_null($le->nne_dDateDeces)){ ?>
													<a onclick="return confirm('Confirmer vous le décès du nouveau né ?');" href="<?php echo site_url("hospitalisation/deces_nouveauNe/".$le->nne_id); ?>"><b>Décéder</b></a> 
													<?php } ?>
													</td>
												</tr>
											<?php } ?>
											...
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														...
														<input type="time" name="heuredeces" class="form-control timepicker obligatoire">
														<input type="hidden" value="<?php echo $acm_id; ?>" name="id">
														<input type="hidden" value="<?php echo $patient->pat_id; ?>" name="pat_soins">
														<input type="hidden" value="<?php echo $hos->hos_id; ?>" name="hos">
														<input type="hidden" name="cout" value="<?php echo $nbJour*$hos->cha_iPrixLit;?>"/>
...
<div class="modal fade" id="modalPartogramme" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height:500px; overflow:auto;">
				 <div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						<div class="body table-responsive">
							<div class="col-md-12" id="recepPartogramme"></div>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form id="motif-fin">
					<div class="form-group">
					<?php $listeMotifs = $this->md_parametre->liste_motif_fin_hospitalisation(); ?>
						...
						<select name="motif" class="form-control obligatoire" style="border:1px solid black">
							<option value="">------- Choisir -------</option>
							<?php foreach($listeMotifs as $l){ ?>
								<option value="<?= $l->mfh_id;?>"><?= $l->mfh_sLibelle;?></option>
							<?php } ?>
						</select>
					</div>
				</form>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg" role="document" style="margin-top:20px; max-width:90%">
		<div class="modal-content">
							...
							<div class="col-sm-12 retour-new-ne"></div>
								<div class="row clearfix">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
												...
												<input type="time" name="heureDate" class="form-control timepicker obligatoire">
												<input type="hidden" value="<?php echo $acm_id; ?>" name="id">
												<input type="hidden" value="<?php echo $patient->pat_id; ?>" name="pat_soins">
											</div>
										</div>
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
											<label style="color:#000">Type d'accouchement *</label>
												<select name="type" class="form-control obligatoire">
													<option value="">------ Selectionner -------</option>
													<option value="1">Accouchement eutocique</option>
													<option value="2">Accouchement dystocique</option>
													<option value="3">Accouchement par césarienne</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
											<label style="color:#000">Lieu d'accouchement *</label>
												<select name="lieu" class="form-control obligatoire">
													<option value="">------ Selectionner -------</option>
													<option value="1">à domicile</option>
													<option value="2">à l' hopitale</option>
												</select>
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
											<label style="color:#000">Type de grossesses *</label>
												<select name="typegro" class="form-control obligatoire">
													<option value="">------ Selectionner -------</option>
													<option value="1">Mono-foetal</option>
													<option value="2">Gémelaire</option>
												</select>
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
											<label style="color:#000">Etat de l'enfant *</label>
												<select name="etat" class="form-control obligatoire">
													<option value="">------ Selectionner -------</option>
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
											<label style="color:#000">Etat phisyque de l'enfant *</label>
												<select name="etatPhi" class="form-control obligatoire">
													<option value="">------ Selectionner -------</option>
													<option value="1">Prématuré</option>
													<option value="2">Non prématuré</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="form-line">
												...
												<input type="text" name="poids" class="form-control obligatoire">
											</div>
										</div>
									</div>
			...
			<div class="modal-footer">
				<a href="javascript:();" class="btn btn-success waves-effect" style="color:#fff" id="AddNouveauNe"><i class="fa fa-check"></i> Enregistrer</a>
