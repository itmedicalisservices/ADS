					...
					<div class="body">
                       ...
                       <!-- <form id="rapport-epidem" action="" method="post">
                        ...
                        <div class="body table-responsive"> 
                            <?php //var_dump($liste);?>
                            <div class="header">
                                <h2>VIII GESTION DU PERSONNEL : Personnel pa qualification, sex et structures</h2>
                                <a class="" href="<?php echo site_url("impression/gestion_du_personnel/$premier/$dernier"); ?>">Imprimer</a>
                            </div>
                                ...
                                <table id="example" class="table text-center table-bordered table-striped table-hover">
                                    ...
                                    <tbody class="corps">
                                        ...
                                        <tr> 
                                            ...
                                            <td align="center"><?php $nbPerH = $this->md_personnel->nb_complete_personnel_post($l->pst_id,"H"); echo $nbPerH->nb; $som_1 += $nbPerH->nb; ?></td>
