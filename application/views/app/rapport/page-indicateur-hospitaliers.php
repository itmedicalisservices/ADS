...
<?php 
	...
	$date = date("Y-m-d");
	$casReferer = "référé";
	$contreReferer = "contre référé";
	$autoReferer = "auto référé";
	$guerison = "guerison"; $evasion = "evasion remission"; $refere = "refere"; $deces = "deces"; $demande = "a la demande";
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					...
					<div class="body">
						<form id="rapport-indicateur" action="" method="post">
							<div class="row clearfix">
								...
								<div class="col-sm-2">
								<br><br>
									<button type="submit" class="btn btn-raised bg-blue-grey" id="indicateur">Valider</button>
								</div>
							</div>
						</form>
							...
							<table id="example1" class="table table-bordered table-striped table-hover">
								...
								<tfoot>
									<td style="font-weight:bold">Total</td>
										<td align="center"><?php echo $somLit_1; ?></td>
						...
						<div class="table-responsive">
							<table id="example2" class="table table-bordered table-striped table-hover">
								...
								<tbody class="corps">
									...
									foreach($liste AS $l) { ?>
									<tr> 
										<td><?php if($l->sm2_sLibelle !=NULL){echo $l->sm2_sLibelle ;}elseif($l->sm1_sLibelle !=NULL){echo $l->sm1_sLibelle ;}elseif($l->mal_sLibelle !=NULL){echo $l->mal_sLibelle ;} ?></td>
										<td style="background:rgb(255,149,149)" align="center"><?php if($l->sm2_sCode !=NULL){echo $l->sm2_sCode ;}elseif($l->sm1_sCode !=NULL){echo $l->sm1_sCode ;}elseif($l->mal_sCode !=NULL){echo $l->mal_sCode ;} ?></td>
										<td align="center"><?php $nc = $this->md_patient->rapport_maladie_nouveau($l->sm1_id,$l->sm2_id,$l->mal_id,$premier,$dernier);echo $nc->nb;$som_1=$som_1+$nc->nb;?></td>
										<td align="center"><?php $ac = $this->md_patient->rapport_maladie_ancien($l->sm1_id,$l->sm2_id,$l->mal_id,$premier);echo $ac->nb;$som_2=$som_2+$ac->nb;?></td>
										<td align="center"><?php echo $nc->nb + $ac->nb; ?></td>
										<td align="center"><?php $chmoisun = $this->md_patient->rapport_maladie_moin_1($l->sm1_id,$l->sm2_id,$l->mal_id,$moinsun,"H");echo $chmoisun->nb;$som_4=$som_4+$chmoisun->nb;?></td>
										<td align="center"><?php $cfmoisun = $this->md_patient->rapport_maladie_moin_1($l->sm1_id,$l->sm2_id,$l->mal_id, $moinsun,"F"); echo $cfmoisun->nb;$som_5=$som_5+$cfmoisun->nb;?></td>
										<td align="center"><?php $ch14 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun,"H"); echo $ch14->nb;$som_6=$som_6+$ch14->nb;?></td>
										<td align="center"><?php $cf14 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun,"F"); echo $cf14->nb;$som_7=$som_7+$cf14->nb;?></td>
										<td align="center"><?php $ch514 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14,"H"); echo $ch514->nb;$som_8=$som_8+$ch514->nb;?></td>
										<td align="center"><?php $cf514 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14,"F"); echo $cf514->nb;$som_9=$som_9+$cf514->nb;?></td>
										<td align="center"><?php $ch1549 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514,"H"); echo $ch1549->nb;$som_10=$som_10+$ch1549->nb;?></td>
										<td align="center"><?php $cf1549 = $this->md_patient->rapport_maladie_1_a_49($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514,"F"); echo $cf1549->nb; $som_11=$som_11+$cf1549->nb;?></td>
										<td align="center"><?php $ch50plus = $this->md_patient->rapport_maladie_50_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus,"H"); echo $ch50plus->nb;$som_12=$som_12+$ch50plus->nb;?></td>
										<td align="center"><?php $cf50plus = $this->md_patient->rapport_maladie_50_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus,"F"); echo $cf50plus->nb;$som_13=$som_13+$cf50plus->nb;?></td>
						...
						<div class="table-responsive">
							<table id="example_copy_4" class="table table-bordered table-striped table-hover">
								...
								<tbody class="corps">
									...
									<?php $nbExaLab = $this->md_laboratoire->recup_rapport_laboratoire($l->lac_id,$premier,$dernier); ?>
									<?php if(count($nbExaLab) != 0): ?>
									<tr> 
										<td align="center" style="font-size:11.5px;">
											<?php 
												if(strlen($cpt)==1){
										...
										<td><?php echo $l->lac_sLibelle; ?></td>
										<td align="center"><?php echo count($nbExaLab); ?></td>
										<td align="center"></td>
										<?php $compter++ ?>
									</tr>
									<?php endif; ?>
							...
							<table id="example_copy_5" class="table table-bordered table-striped table-hover">
								...
								<?php //var_dump($premier,$dernier); ?>
									...
									<tr> 
										<td><?php if($l->sm2_sLibelle !=NULL){echo $l->sm2_sLibelle ;}elseif($l->sm1_sLibelle !=NULL){echo $l->sm1_sLibelle ;}elseif($l->mal_sLibelle !=NULL){echo $l->mal_sLibelle ;} ?></td>
										<td style="background:rgb(255,149,149)" align="center"><?php if($l->sm2_sCode !=NULL){echo $l->sm2_sCode ;}elseif($l->sm1_sCode !=NULL){echo $l->sm1_sCode ;}elseif($l->mal_sCode !=NULL){echo $l->mal_sCode ;} ?></td>
										<td align="center"><?php $m15Moins3 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,0,3); echo $m15Moins3->nb;$som_1+=$m15Moins3->nb;?></td>
										<td align="center"><?php $f1517Moins3 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,0,3);echo $f1517Moins3->nb;$som_2+=$f1517Moins3->nb;?></td>
										<td align="center"><?php $f1835Moin3 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,0,3);echo $f1835Moin3->nb;$som_3+=$f1835Moin3->nb;?></td>
										<td align="center"><?php $f36plusMoins3 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,0,3);echo $f36plusMoins3->nb;$som_4+=$f36plusMoins3->nb;?></td>


										<td align="center"><?php $m15Moins6 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,4,6);echo $m15Moins6->nb;$som_5+=$m15Moins6->nb;?></td>
										<td align="center"><?php $f1517Moins6 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,4,6);echo $f1517Moins6->nb;$som_6+=$f1517Moins6->nb;?></td>
										<td align="center"><?php $f1835Moins6 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,4,6);echo $f1835Moins6->nb;$som_7+=$f1835Moins6->nb;?></td>
										<td align="center"><?php $f36plusMoins6 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,4,6);echo $f36plusMoins6->nb;$som_8+=$f36plusMoins6->nb;?></td>


										<td align="center"><?php $m15Moins9 = $this->md_patient->rapport_femme_enceinte_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier,7,9);echo $m15Moins9->nb;$som_9+=$m15Moins9->nb;?></td>
										<td align="center"><?php $f1517Moins9 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier,7,9);echo $f1517Moins9->nb;$som_10+=$f1517Moins9->nb;?></td>
										<td align="center"><?php $f1835Moins9 = $this->md_patient->rapport_femme_enceinte_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier,7,9);echo $f1835Moins9->nb;$som_11+=$f1835Moins9->nb;?></td>
										<td align="center"><?php $f36plusMoins9 = $this->md_patient->rapport_femme_enceinte_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier,7,9);echo $f36plusMoins9->nb;$som_12+=$f36plusMoins9->nb;?></td>
								...
								<tfoot>
									<tr>
										...
										<td align="center"><?php echo $som_11; ?></td>
										<td align="center"><?php echo $som_12; ?></td>
										<td align="center"><?php echo $som_1+$som_2+$som_3+$som_4+$som_5+$som_6+$som_7+$som_8+$som_9+$som_10+$som_11+$som_12; ?></td>
										<td align="center"></td>
									</tr>
								</tfoot>
							</table>
							...
							<table id="example_copy_6" class="table table-bordered table-striped table-hover">
								...
								<tbody class="corps">
									...
									<tr> 
										<td><?php if($l->sm2_sLibelle !=NULL){echo $l->sm2_sLibelle ;}elseif($l->sm1_sLibelle !=NULL){echo $l->sm1_sLibelle ;}elseif($l->mal_sLibelle !=NULL){echo $l->mal_sLibelle ;} ?></td>
										<td style="background:rgb(255,149,149)" align="center"><?php if($l->sm2_sCode !=NULL){echo $l->sm2_sCode ;}elseif($l->sm1_sCode !=NULL){echo $l->sm1_sCode ;}elseif($l->mal_sCode !=NULL){echo $l->mal_sCode ;} ?></td>
										<td align="center"><?php $m15 = $this->md_patient->rapport_femme_poste_natal_malade_moins_15($l->sm1_id,$l->sm2_id,$l->mal_id,$m115,$premier,$dernier);echo $m15->nb;$som_1+=$m15->nb;?></td>
										<td align="center"><?php $f1517 = $this->md_patient->rapport_femme_poste_natal_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1517,$m115,$premier,$dernier);echo $f1517->nb;$som_2+=$f1517->nb;?></td>
										<td align="center"><?php $f1835 = $this->md_patient->rapport_femme_poste_natal_malade_15_35($l->sm1_id,$l->sm2_id,$l->mal_id,$m1835,$m1517,$premier,$dernier);echo $f1835->nb;$som_3+=$f1835->nb;?></td>
										<td align="center"><?php $f36plus = $this->md_patient->rapport_femme_poste_natal_malade_63_et_plus($l->sm1_id,$l->sm2_id,$l->mal_id,$m36plus,$premier,$dernier);echo $f36plus->nb;$som_4+=$f36plus->nb;?></td>
