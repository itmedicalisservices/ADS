							...
							<table id="example1" class="table table-bordered table-striped table-hover">
								...
								<tbody class="corps">
									...
									<tr> 
										...
										<td align="center"><?php $chmoisun = $this->md_patient->rapport_maladie_moin_1_cas_homme($l->sm1_id,$l->sm2_id,$l->mal_id,trim($moinsun));echo $chmoisun->nb;$som_1=$som_1+$chmoisun->nb;?></td>
										<td align="center"><?php $cfmoisun = $this->md_patient->rapport_maladie_moin_1_cas_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$moinsun); echo $cfmoisun->nb;$som_2=$som_2+$cfmoisun->nb;?></td>
										<td align="center"><?php $dhmoisun = $this->md_patient->rapport_maladie_moin_1_deces_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$moinsun); echo $dhmoisun->nb;$som_3=$som_3+$dhmoisun->nb;?></td>
										<td align="center"><?php $dfmoisun = $this->md_patient->rapport_maladie_moin_1_deces_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$moinsun); echo $dfmoisun->nb;$som_4=$som_4+$dfmoisun->nb;?></td>
										<td align="center"><?php $ch14 = $this->md_patient->rapport_maladie_1_a_49_cas_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun); echo $ch14->nb;$som_5=$som_5+$ch14->nb;?></td>
										<td align="center"><?php $cf14 = $this->md_patient->rapport_maladie_1_a_49_cas_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun); echo $cf14->nb;$som_6=$som_6+$cf14->nb;?></td>
										<td align="center"><?php $dh14 = $this->md_patient->rapport_maladie_1_a_49_deces_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun); echo $dh14->nb;$som_7=$som_7+$dh14->nb;?></td>
										<td align="center"><?php $df14 = $this->md_patient->rapport_maladie_1_a_49_deces_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m14,$moinsun); echo $df14->nb;$som_8=$som_8+$df14->nb;?></td>
										<td align="center"><?php $ch514 = $this->md_patient->rapport_maladie_1_a_49_cas_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14 ); echo $ch514->nb;$som_9=$som_9+$ch514->nb;?></td>
										<td align="center"><?php $cf514 = $this->md_patient->rapport_maladie_1_a_49_cas_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14 ); echo $cf514->nb;$som_10=$som_10+$cf514->nb;?></td>
										<td align="center"><?php $dh514 = $this->md_patient->rapport_maladie_1_a_49_deces_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14); echo $dh514->nb;$som_11=$som_11+$dh514->nb;?></td>
										<td align="center"><?php $df514 = $this->md_patient->rapport_maladie_1_a_49_deces_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m514,$m14); echo $df514->nb;$som_12=$som_12+$df514->nb;?></td>
										<td align="center"><?php $ch1549 = $this->md_patient->rapport_maladie_1_a_49_cas_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514); echo $ch1549->nb;$som_13=$som_13+$ch1549->nb;?></td>
										<td align="center"><?php $cf1549 = $this->md_patient->rapport_maladie_1_a_49_cas_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514); echo $cf1549->nb; $som_14=$som_14+$cf1549->nb;?></td>
										<td align="center"><?php $dh1549 = $this->md_patient->rapport_maladie_1_a_49_deces_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514); echo $dh1549->nb;$som_15=$som_15+$dh1549->nb;?></td>
										<td align="center"><?php $df1549 = $this->md_patient->rapport_maladie_1_a_49_deces_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m1549,$m514); echo $df1549->nb;$som_16=$som_16+$df1549->nb;?></td>
										<td align="center"><?php $ch50plus = $this->md_patient->rapport_maladie_50_et_plus_cas_homme($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus); echo $ch50plus->nb;$som_17=$som_17+$ch50plus->nb;?></td>
										<td align="center"><?php $cf50plus = $this->md_patient->rapport_maladie_50_et_plus_cas_femme($l->sm1_id,$l->sm2_id,$l->mal_id,$m50plus); echo $cf50plus->nb;$som_18=$som_18+$cf50plus->nb;?></td>
										<td align="center"><?php $dh50plus = $this->md_patient->rapport_maladie_50_et_plus_deces_homme($l->sm1_id,$l->sm2_id,$l->mal_id); echo $dh50plus->nb;$som_19=$som_19+$dh50plus->nb;?></td>
										<td align="center"><?php $df50plus = $this->md_patient->rapport_maladie_50_et_plus_deces_femme($l->sm1_id,$l->sm2_id,$l->mal_id); echo $df50plus->nb;$som_20=$som_20+$df50plus->nb;?></td>
