			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					...
					<div class="body">
						...
						<br><a class="small" href="<?php echo site_url("impression/materiel_lourd/$premier/$dernier"); ?>">Imprimer</a></h2>						
						...
						<br><a class="small" href="<?php echo site_url("impression/materiel_medico_technique/$premier/$dernier"); ?>">Imprimer</a></h2>	
						...
						<br><a class="small" href="<?php echo site_url("impression/materiel_roulant/$premier/$dernier"); ?>">Imprimer</a></h2>
						...
						<br><a class="small" href="<?php echo site_url("impression/mobilier/$premier/$dernier"); ?>">Imprimer</a></h2>
