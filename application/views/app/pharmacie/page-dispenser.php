...
<?php $medicament = $this->md_pharmacie->recup_med_facture($fac,$med); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
                    ...
                    <div class="body table-responsive">
						<form id="form-vendre">
							...
							<table class="table table-bordered table-striped table-hover">
								<thead>
									...
									<tr>
										<td colspan="">
											<?=$medicament->med_sNc." ".$medicament->for_sLibelle;?>
										</td>
										<td colspan="">
											<?=$medicament->elf_iQte;?>
										</td>
									...
									<tr>
										<th colspan="2">Code à barre du produit *</th>
										<th colspan="" style="width:60px"  class="text-center"><i class="fa fa-wrench"></i></th>
									</tr>
									<tr>
										<td colspan="2">
											...
											<input style="" type="hidden" name="fac" value="<?=$fac?>" />
											<input style="" type="hidden" name="dis" value="<?=$medicament->dis_id?>" />
										</td>
									...
									<tr>
										<th>Produit *</th>
										<th style="width:100px" class="text-center cacher">PU (Fcfa) *</th>
										<th style="width:100px" class="text-center ">Quantité *</th>
										<th style="width:200px"  class="text-center cacher">Montant (Fcfa) </th>
						...
						<a href="javascript:();" class="btn btn-success waves-effect vendre2 pull-right" style="color:#fff"><i class="fa fa-check"></i> Valider</a>
                    </div>
