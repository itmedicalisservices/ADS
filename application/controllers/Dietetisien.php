...
class Dietetisien extends CI_Controller {
	...
	public function hospitalisation_dietetisien()
	{
		$this->load->view('app/dietetisien/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/dietetisien/page-journal-hospitalisation');
	}
