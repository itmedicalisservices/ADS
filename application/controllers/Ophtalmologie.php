...
class Ophtalmologie extends CI_Controller {
	...
	public function hospitalisation_ophtalmologie()
	{
		$this->load->view('app/ophtalmologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/ophtalmologie/page-journal-hospitalisation');
	}
