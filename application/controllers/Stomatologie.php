...
class Stomatologie extends CI_Controller {
	...
	public function hospitalisation_stomatologie()
	{
		$this->load->view('app/stomatologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/stomatologie/page-journal-hospitalisation');
	}
