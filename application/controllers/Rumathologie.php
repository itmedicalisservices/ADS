...
class Rumathologie extends CI_Controller {
	...
	public function hospitalisation_rumathologie()
	{
		$this->load->view('app/rumathologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/rumathologie/page-journal-hospitalisation');
	}
