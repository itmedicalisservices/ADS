...
class Rapport extends CI_Controller {
	...
	public function accouchements_naissances()
	{
		$this->load->view('app/rapport/page-accouchements-naissances.php');
	}	
	//RABY
	...
	{
		$this->load->view('app/rapport/page-prise-en-charge.php');
	}
	...
	{
		$this->load->view('app/rapport/page-liste-equipement.php');
	}
