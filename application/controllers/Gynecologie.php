...
class Gynecologie extends CI_Controller {
	...
	public function hospitalisation_gynecologie()
	{
		$this->load->view('app/gynecologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/gynecologie/page-journal-hospitalisation');
	}
					...
					<div class="body p-l-0 p-r-0">
						<div class="row clearfix" style="margin-bottom:12px">	
							...
							<div class="col-sm-12">
								...
								if(!is_null($c->exp_sDev)){echo $c->exp_sDev ;}else{echo '<i><br>Non renseignée</i>';}
							echo '</label>
							</div>
						</div>
	...
	public function addExamEchographique()
	{
		...
		$data = $this->input->post();
			...
			$donnees = array(
					...
					"eec_sPrescripteur"=>$this->md_config->get_session(),
	...
	public function addExamSenologique()
	{
		...
		$donnees = array(
			...
			"ese_sPrescripteur" => $this->md_config->get_session(),
	...
	public function reponse_avis(){
		...
		if(!isset($data)){
			...
			$donnees = array(
				...
				"avs_iPer"=>$this->md_config->get_session(),
