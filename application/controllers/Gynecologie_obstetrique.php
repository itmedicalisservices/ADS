...
class Gynecologie_obstetrique extends CI_Controller {
	...
	public function hospitalisation_gynecologie_obstetrique()
	{
		$this->load->view('app/gynecologie_obstetrique/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/gynecologie_obstetrique/page-journal-hospitalisation');
	}
