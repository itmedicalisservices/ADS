...
class Cardiologie extends CI_Controller {
	...
	public function hospitalisation_cardologie()
	{
		$this->load->view('app/cardiologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/cardiologie/page-journal-hospitalisation');
	}
