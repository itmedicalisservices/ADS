...
class pediatrie extends CI_Controller {
	...
	public function hospitalisation_pediatrie()
	{
		$this->load->view('app/pediatrie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/pediatrie/page-journal-hospitalisation');
	}
