...
class Gastroenterologie extends CI_Controller {
	...
	public function hospitalisation_gastroenterologie()
	{
		$this->load->view('app/cardigastroenterologieologie/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/gastroenterologie/page-journal-hospitalisation');
	}
