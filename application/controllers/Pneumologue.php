...
class Pneumologue extends CI_Controller {
	...
	public function hospitalisation_pneumologue()
	{
		$this->load->view('app/pneumologue/page-liste-hospitalisation');
	}

	public function journal()
	{
		$this->load->view('app/pneumologue/page-journal-hospitalisation');
	}
