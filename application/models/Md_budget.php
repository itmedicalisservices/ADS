...
class Md_budget extends CI_Model {
	...
	protected $tableLib = "armee.t_lignes_budgetaires_lib";
	protected $tableBun = "armee.t_budget_unite_bun";
	protected $tableHib = "armee.t_historique_budgetaire_hib";
	...
	protected $tableOpb = "armee.t_operation_budget_opb";
	protected $tableBul = "armee.t_budget_alloue_bul";
