...
class Md_laboratoire extends CI_Model {
	...
	protected $tableEac = "armee.t_entree_accessoire_eac";
	protected $tableAcc = "armee.t_accessoire_acc";
	protected $tableSac = "armee.t_stock_accessoire_sac";
	protected $tableAcs = "armee.t_accessoire_acs";
	protected $tablePer = "armee.t_personnel_per";
	
	protected $tableAla = "armee.t_acte_laboratoire_ala";
	protected $tableTan = "armee.t_tube_analyse_tan";
	...
	public function recup_rapport_laboratoire($lac,$debut,$fin){
		return $this->db
					->select("ala.ala_id")
					->Distinct("ala.ala_id")
					->join($this->tableTan." tan", 'ala.ala_id=tan.ala_id','inner')
					->join($this->tableAcm." acm", 'acm.acm_id=ala.acm_id','inner')
					->join($this->tableLac." lac", 'lac.lac_id=acm.lac_id','inner')
					->where("tan.tan_dDateRapport >=",$debut)
					->where("tan.tan_dDateRapport <=",$fin)
