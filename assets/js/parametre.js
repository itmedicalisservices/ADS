...
$(".addAnteObs").click(function(){
	...
	if(nbError == 0){
		var data = $('form#form-lob').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutAntecedentObs,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$(".addLiv").click(function(){
	...
	if(nbError == 0){
		var data = $('form#form-liv').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutVaccin,
...
$(".addLso").click(function(){
	...
	if(nbError == 0){
		var data = $('form#form-lso').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutSource,
...
$(".addChap").click(function(){
	...
	if(nbError == 0){
		var data = $('form#form-chap').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutChapitre,
...
$(".addClas").click(function(){
	...
	if(nbError == 0){
		var data = $('form#form-clas').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutClasse,
...
$(".addSous1").click(function(){
	...
	//alert(nbError);
	if(nbError == 0){
		var data = $('form#form-sous1').serialize();
		 alert(data);
		$.ajax({
			type:"POST",
			url: ajoutSousMaladie1,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$(".addSous2").click(function(){
	...
	//alert(nbError);
	if(nbError == 0){
		var data = $('form#form-sous2').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutSousMaladie2,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$(".addMotif_Fin_Hos").click(function(){
	// alert();
	var nbError = 0;
	var tab = $("#tbody").html();
	if($.trim(tab)==""){
	...
	if(nbError == 0){
		var data = $('form#form-Motif_Fin_Hos').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: ajoutMotif_Fin_Hos,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$(".editLIVFinal").click(function(){
	//alert(1);
	var rel=$(this).attr('rel');
	var data = $('form#form-edit-liv'+rel).serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: modifierVaccin,
