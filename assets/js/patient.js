...
//RABY
$("#SoldePresc").click(function(){
	 //alert('ok');
	var nbError = 0;
	
	$("form#stat-prescripteur input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			nbError++;
		}
	...
	if(nbError == 0){
		...
		var data = $('form#stat-prescripteur').serialize();
		 //alert(data);
		$.ajax({
			type:"POST",
			url: soldePrescripteur,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$("#PrescActe").click(function(){
	 //alert('ok');
	var nbError = 0;
	
	$("form#stat-PrescActe input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			nbError++;
		}
	...
	if(nbError == 0){
		...
		var data = $('form#stat-PrescActe').serialize();
		 //alert(data);
		$.ajax({
			type:"POST",
			url: prescripteur_Actes,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
...
$("#MedecincActe").click(function(){
	 //alert('ok');
	var nbError = 0;
	
	$("form#stat-MedecincActe input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			nbError++;
		}
	...
	if(nbError == 0){
		...
		var data = $('form#stat-MedecincActe').serialize();
		 //alert(data);
		$.ajax({
			type:"POST",
			url: prescription_Actes_madecin,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
		...
		.done(function(retour){
			//alert(retour);
			$("#afficheMedecincActe").html(retour);
		});
...
$("#Solde_Quote_part").click(function(){
	 //alert('ok');
	var nbError = 0;
	
	$("form#stat-quote input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			nbError++;
		}
	...
	if(nbError == 0){
		...
		var data = $('form#stat-quote').serialize();
		 //alert(data);
		$.ajax({
			type:"POST",
			url: solde_Quote_part,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
		...
		.done(function(retour){
			//alert(retour);
			$("#afficheSoldeQuotePart").html(retour);
		});
...
$("#showAssureur").click(function(){
	// alert();
	
	var nbError = 0;
	$("form#form-recouvrement-assureur input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			$(this).addClass("obligatoire-color");
			nbError++;
	...
	$("form#form-recouvrement-assureur form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
			$(this).parent("div").addClass("has-error");
			$(this).addClass("obligatoire-color");
			nbError++;
	...
	if(nbError == 0){
		var data = $('form#form-recouvrement-assureur').serialize();
		 //alert(data);
		$.ajax({
			type:"POST",
			url: liste_recouvrement_assurance,
			data:data,
			async:true,
			error:function(xhr, status, error){
				alert(xhr.responseText);
		...
		.done(function(retour){
			 //alert(retour);
			$('.Liste_recouvrement_assurance').html(retour);
