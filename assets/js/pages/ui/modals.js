...
$("#rechFac").click(function(){
	// alert('ok');
	var nbError = 0;
	
	$("form#form-rech-fac input.form-control.obligatoire").each(function(){
		if($.trim($(this).val()) == ""){
	...
	if(nbError == 0){
		...
		var data = $('form#form-rech-fac').serialize();
		// alert(data);
		$.ajax({
			type:"POST",
			url: rechFacNum,
...
$(function () {
    $('.ajout_armoire').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selectdep').select2({
...
$(function () {
    $('.ajout_chambre').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selectSer').select2({
...
$(function () {
    $('.ajout_element').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		
		$('.select2').select2({
			placeholder: "----- Choisissez l'acte médical * -----",
			allowClear: true,
			dropdownParent: $('#largeModal')
		});
...
$(function () {
    $('.ajout_domaine').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selecttypePer').select2({
...
$(function () {
    $('.ajout_specialite').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selecttypePer').select2({
...
$(function () {
    $('.ajout_reactif').on('click', function () {
        var color = $(this).data('color');
        $('#mdModalType .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#mdModalType').modal('show');
		$('.selectReact').select2({
			placeholder: "----- Choisissez les examens pour ce réactif -----",
			allowClear: true,
			dropdownParent: $('#mdModalType')
		});
...
$(function () {
    $('.ajout_maladie').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selectdep').select2({
...
$(function () {
    $('.ajout_quotes').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selectmedecin').select2({
			placeholder: "--Selectionnez le medecin--",
			allowClear: true,
			dropdownParent: $('#largeModal')
		});
...
$(function () {
    $('.ajout_divers').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selecttya').select2({
			placeholder: "----- Choisissez le libellé * -----",
			allowClear: true,
			dropdownParent: $('#largeModal')
		});
		$('.selectuni').select2({
...
$(function () {
    $('.ajout_specification').on('click', function () {
        var color = $(this).data('color');
        $('#largeModal .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#largeModal').modal('show');
		$('.selectdep').select2({
			placeholder: "----- Choisissez la maladie * -----",
			allowClear: true,
			dropdownParent: $('#largeModal')
		});
...
$(function () {
    $('.Partogramme_sej').on('click', function () {
        var color = $(this).data('color');
		var paye=$(this).attr("rel");
        $('#modalPartogramme .modal-content').removeAttr('class').addClass('modal-content modal-col-' + color);
        $('#modalPartogramme').modal('show');
    });
});
